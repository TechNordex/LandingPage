      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="relative z-10 rounded-2xl border border-primary/30 bg-card p-12 md:p-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#contato"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-md bg-primary text-primary-foreground font-semibold text-base hover:opacity-90 transition-opacity"
            >
              Falar com especialista <ArrowRight size={18} />
            </a>
            <a
              href="#solucoes"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-md border border-border text-foreground font-semibold text-base hover:bg-secondary transition-colors"
            >
              Ver soluções
            </a>
          </div>
